/* @(#) $Id: //bas/710_REL/src/include/sapuc.h#7 $ SAP*/
/* CCQ_CCU_FILE_OFF */ /* CCQ_IPV6_SUPPORT_FILE_OK */ /* CCQ_USE_TIME_T_FILE_OK */
#ifndef SAPUC_H
#define SAPUC_H "$Id: //bas/710_REL/src/include/sapuc.h#7 $"
...
#define sccsidR   sccsid
  ...
  externC DECL_EXP SAP_UC* CDCL_U ConvertSCCSID_w( const char *sccsid );
#endif
...
#define strcatR( dest, src )        strcat( dest, src )
...
#define strcpyR( dest, src )        strcpy( dest, src )
...
#define strdupU                     SAP_UNAME(_strdup)

#define strlenR( s )                strlen( s )
...
#define strncatR( dest, src, n )    strncat( dest, src, n )
...
#define strncpyR( dest, src, n )    strncpR( dest, src, n )
...
#define fputsR( s, stream )            fputs( s, stream )
